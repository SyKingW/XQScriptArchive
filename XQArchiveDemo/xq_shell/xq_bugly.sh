...
# APPID #
BUGLY_APP_ID=${xq_BUGLY_APP_ID}
# key #
BUGLY_APP_KEY=${xq_BUGLY_APP_KEY}
# bundleid #
BUNDLE_IDENTIFIER=${xq_PRODUCT_BUNDLE_IDENTIFIER}
...
function run() {
    ...
    echo "Scaning dSYM FOLDER: ${DSYM_FOLDER} ..."ls
...
if [ $BuildInXcode = "T" ]; then
    ...
    # wxq 填入自定义参数
    echo "BUGLY_APP_ID: $1"
    echo "BUGLY_APP_KEY: $2"
    echo "BUNDLE_IDENTIFIER: $3"
    echo "BUGLY_APP_VERSION: $4"
    echo "DWARF_DSYM_FOLDER_PATH: $5"
    echo "SYMBOL_OUTPUT_PATH: $6"
    echo "UPLOAD_DSYM_ONLY: $7"
